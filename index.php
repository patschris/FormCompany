...
<BODY bgcolor="#FFFFCC" >
    ...
    <FORM METHOD="POST" ACTION="part2.php">
        &nbsp;&nbsp;&nbsp;&nbsp;Μισθός:&nbsp;&nbsp;&nbsp;
        <SELECT name="avg_salary" style="width: 170px;" required>
    ...
    <FORM METHOD="POST" ACTION="part3.php">
        <TABLE cellpadding="1" cellspacing="0" width="500" >
            <TR>
                ...
                <TD valign="middle"> <input type="text" name="id" placeholder="Κωδικός αριθμός" style="width: 158px;" required/> </TD>
            </TR>
            <TR>
                <TD valign="middle"> &nbsp;&nbsp;&nbsp;&nbsp; Όνομα: </TD>
                <TD valign="middle"> <input type="text" name="name" placeholder="Όνομα" style="width: 158px;" required/> </TD>
            </TR>
            <TR>
                <TD valign="middle"> &nbsp;&nbsp;&nbsp;&nbsp; Επώνυμο: </TD>
                <TD valign="middle"> <input type="text" name="last_name" placeholder="Επώνυμο" style="width: 158px;" required/> </TD>
            </TR>
            <TR>
                <TD valign="middle"> &nbsp;&nbsp;&nbsp;&nbsp; Ημερομηνία γέννησης: </TD>
                <TD valign="middle"> <input type="text" name="b_date" placeholder="Ημερομηνία γέννησης" style="width: 158px;" required/> </TD>
            </TR>
            <TR>
            ...
            <TR>
                ...
                <TD valign="middle"> <input type="text" name="salary" placeholder="Μισθός" style="width: 158px;" required/> </TD>
            </TR>
            <TR>
                <TD valign="middle"> &nbsp;&nbsp;&nbsp;&nbsp; Τμήμα: </TD>
                <TD valign="middle">
                    <SELECT name="dept" style="width: 158px;" required>
                        <?php
